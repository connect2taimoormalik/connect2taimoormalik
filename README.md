# Hi, I'm Taimoor Athar Malik 👋

Full-stack Software Engineer with around 5 years of experience building scalable, production-grade SaaS platforms using Ruby on Rails, Python, Java, React.js, and React Native. Skilled in designing and building systems that scale reliably for enterprise clients, with strong expertise in backend architecture, domain modeling, RESTful API development, and database optimization. Experienced in mentoring engineers, delivering enterprise-grade customizations, and improving product reliability through performance tuning and engineering best practices.

📍 Uppsala, Sweden  
📧 connect2taimoormalik@gmail.com  
🔗 [LinkedIn](#)
...
I build and scale enterprise SaaS products — from backend architecture and service-oriented design to full ownership of the SDLC: requirements, implementation, testing, and rollout. I've spent the last several years working on enterprise asset management platforms, optimizing systems that serve large-scale client bases in production.

- 🏗️ Designing scalable backend systems and resolving performance bottlenecks (N+1 queries, DB optimization)
...
![RSpec](https://img.shields.io/badge/-RSPEC-A9231C?style=for-the-badge) ![VCR](https://img.shields.io/badge/-VCR-333333?style=for-the-badge)
...
- React – The Complete Guide (React Router & Redux) (2023)
